...
//style attributes for stackpanel
/*
[0]: XAML attribute
[1]: XAML attr alt
[2]: CSS property
[3]: Unit if neccessary
*/
define('xenon/controls/StackPanel/styles',[], function() {
    var styles = [
        ["Width","width","width","px"],
        ["Height","height","height","px"],
        ["Background","background","background-color"],
        ["CornerRadius","cornerradius","border-radius","px"],
        ["Foreground","foreground","color"],
    ]
    return styles;
});
define('xenon/controls/StackPanel/attributes',[], function() {
    //handles attributes for the control(any attribute that isnt a style)
    var attributes = [
        ["x:Name","x:name","id"],
    ]
    return attributes;
...
define('xenon/controls/StackPanel',[
...
define('xenon/controls/TextBox/styles',[], function() {
    var styles = [
        ["Width","width","width","px"],
        ["Height","height","height","px"],
        ["Background","background","background-color"],
        ...
        ["FontSize","fontsize","font-size","px"],
...
define('xenon/controls/TextBox/attributes',[], function() {
    //handles attributes for the control(any attribute that isnt a style)
    var attributes = [
...
define('xenon/controls/TextBlock/attributes',[], function() {
    //handles attributes for the control(any attribute that isnt a style)
    var attributes = [
        ["x:Name","x:name","id"],
    ]
...
define('xenon/controls/TextBlock',[
...
define('xenon/styles/compiler/assembleCSS',[],function() {
    var assembleCSS = {
        buildStylesheet: function(params) {
            console.log("Building stylesheet from parameters: " + params);
        }
    }
    return assembleCSS;
});
//reads the parameters to see what CSS definition they match to, and then returns a properly formatted line
define('xenon/styles/compiler/compilation',[],function() {
    var compilation = {
...
define('xenon/styles/compiler/assembleStyle',["xenon/styles/compiler/compilation"],function(compilation) {
    var assembleStyle = {
